...
namespace Tortuga.Drydock.Models.SqlServer
{
    public class FixEmailCheckConstraint : FixItColumnOperation<SqlDbType>
    {
        ...
        {
            return Column.HasForiegnKeyConstraint == false && Column.TextContentFeatures.HasValue && Column.TextContentFeatures.Value.HasFlag(TextContentFeatures.EmailAddress) && Column.HasCheckConstraint == false;
        }
    }
}
